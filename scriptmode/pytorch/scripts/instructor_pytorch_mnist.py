...
"""
This is the adapted MNIST example code for Amazon SageMaker. It is meant for
the instructors of the workshop, since the participants should go through the
process of creating this script themselves.
The code is adapted from: https://github.com/pytorch/examples/blob/master/mnist/main.py
"""
